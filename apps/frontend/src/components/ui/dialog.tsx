...
import { HTMLDivElementProps } from '@/models/ui/ui-props';
...
const DialogHeader = ({ className, ...props }: HTMLDivElementProps) => (
  <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left', className)} {...props} />
);
DialogHeader.displayName = 'DialogHeader';

const DialogFooter = ({ className, ...props }: HTMLDivElementProps) => (
