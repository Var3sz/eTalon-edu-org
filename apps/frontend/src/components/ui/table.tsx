...
const TableColumnRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
...
TableColumnRow.displayName = 'TableRow';
...
const TableHead = React.forwardRef<HTMLTableCellElement, TableHeaderCellProps>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
...
export { Table, TableBody, TableCaption, TableCell, TableColumnRow, TableFooter, TableHead, TableHeader, TableRow };
